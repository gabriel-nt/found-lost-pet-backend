...
var http_exception_filter_1 = require("./infra/exception/http-exception.filter");
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, httpAdapter, config, document;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    httpAdapter = app.get(core_1.HttpAdapterHost);
