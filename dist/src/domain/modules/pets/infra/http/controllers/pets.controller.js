...
var pet_entity_1 = require("../typeorm/entities/pet.entity");
var PetsController = /** @class */ (function () {
    function PetsController(listPetsService) {
        this.listPetsService = listPetsService;
    }
    PetsController.prototype.list = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.listPetsService.execute()];
                    case 1:
                        response = _a.sent();
    ...
    PetsController = __decorate([
        ...
        __metadata("design:paramtypes", [listPets_service_1.ListPetsService])
    ], PetsController);
