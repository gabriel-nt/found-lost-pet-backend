...
var AuthenticateUserService = /** @class */ (function () {
    function AuthenticateUserService(usersRepository, usersTokensRepository, dateProvider) {
    ...
    AuthenticateUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var user, secret_token, expires_in_token, secret_refresh_token, expires_in_refresh_token, expires_refresh_token_days, passwordMatch, refresh_token, refresh_token_expires_date, token;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!user) {
                            throw new common_1.HttpException('Email or password incorrect', 400);
                        }
