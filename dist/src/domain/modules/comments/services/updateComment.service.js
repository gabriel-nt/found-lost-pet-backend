...
var UpdateCommentService = /** @class */ (function () {
    function UpdateCommentService(commentsRepository) {
        this.commentsRepository = commentsRepository;
    }
    UpdateCommentService.prototype.execute = function (id, data) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.commentsRepository.updateComment(id, data)];
                    case 2:
                        comment = _a.sent();
